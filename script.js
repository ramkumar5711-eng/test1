...
function fetchSensorData() {
    fetch('https://test-f2632-default-rtdb.asia-southeast1.firebasedatabase.app//DHT22/Temperature.json')
        .then(response => response.json())
        .then(data => {
    ...
    fetch('https://test-f2632-default-rtdb.asia-southeast1.firebasedatabase.app//DHT22/Humidity.json')
        .then(response => response.json())
        .then(data => {
    ...
    fetch('https://test-f2632-default-rtdb.asia-southeast1.firebasedatabase.app//BMP180/Pressure.json')
        .then(response => response.json())
        .then(data => {
    ...
    fetch('https://test-f2632-default-rtdb.asia-southeast1.firebasedatabase.app//RainSensor/Status.json')
        .then(response => response.json())
        .then(data => {
